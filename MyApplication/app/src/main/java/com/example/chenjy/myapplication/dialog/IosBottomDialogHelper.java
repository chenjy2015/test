 ...
 */
public class IosBottomDialogHelper extends AbstractDialogHelper {
    ...
    public IosBottomDialogHelper() {
        super();
    }

    IosBottomDialogHelper(AbstractDialogHelper helper) {
        super();
    ...
    public IosBottomDialogHelper title(String title) {
        this.mTitle = title;
        return this;
    }

    public IosBottomDialogHelper negativeColor(@ColorInt int color) {
        this.mNegativeColor = color;
        return this;
    }

    public IosBottomDialogHelper menu(DialogMenu... menus) {
        this.mDialogMenuList = new ArrayList<>(Arrays.asList(menus));
        return this;
    }

    public IosBottomDialogHelper menu(List<DialogMenu> dialogMenuList) {
        this.mDialogMenuList = dialogMenuList;
        return this;
    }

    public IosBottomDialogHelper onMenuSelect(IAction1<DialogMenu> onMenuSelect) {
    ...
    protected View createDialogView(Activity context, Dialog dialog) {
        ...
        SingleAdapter<DialogMenu> adapter = new SingleAdapter(context, mDialogMenuList, R.layout.holder_dialog_ios_bottom_menu, MenuHolder.class);
    ...
    public void notifyItem(List<DialogMenu> list) {
        SingleAdapter<DialogMenu> adapter = (SingleAdapter<DialogMenu>) recyclerView.getAdapter();
